        ...
        <div className="space-y-6 max-w-2xl">
            ...
            <Card>
                <div className="flex items-center gap-4 pb-5 mb-5 border-b border-gray-100">
                    <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-purple-100 to-purple-200 flex items-center justify-center flex-shrink-0">
                    ...
                    <div>
                        ...
                        <span className="inline-flex items-center gap-1 mt-0.5 px-2 py-0.5 rounded-full text-xs font-semibold text-white bg-purple-600">
                            Pastor
                        </span>
                    </div>
                </div>
